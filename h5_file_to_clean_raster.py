# %load h5_file_to_clean_raster.py
import numpy as np
import h5py
import gdal, osr, os
...
def h5_file_to_clean_raster(h5_file_path):
    ...
    siteRefl,siteMetadata=aop_h5refl2array(h5_file_path)
    
    #filtering out band bands
    w = copy.copy(siteMetadata['wavelength'])
    ...
    return cleanRefl, siteMetadata, goodbands